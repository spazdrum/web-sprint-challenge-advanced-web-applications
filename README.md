...
1. Explain what a token is used for.
  ...
  A token is used for verification to access an, otherwise restricted, page.

2. What steps can you take in your web apps to keep your data secure?

  Using authentication tools for users, making private routes, up to date software, make sure data is backed up frequently and using tokens.

3. Describe how web servers work.

  Web servers are used to store information, lifeblood of the internet. Processing network requests, using HTTP and other protocols to respond to the client.

4. Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

  Create, Update, Read and Destroy (CRUD) - PUT/POST, GET, POST/PUT and Destroy=Destroy.
